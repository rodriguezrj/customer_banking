...
def main():
    ...
    # ADD YOUR CODE HERE
    print('The interest earned on the savings account: $', format(interest_earned, ',.2f'))
    print('Updated savings account balance with interest earned',savings_maturity,'months is: $', format(updated_savings_balance, ',.2f'))
    ...
    # ADD YOUR CODE HERE
    print('The interest earned on the CD account: $', format(interest_earned, ',.2f'))
    print('Updated CD account balance after',cd_maturity,'months is: $', format(updated_cd_balance, ',.2f'))
